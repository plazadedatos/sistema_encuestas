  ...
  const handleEditar = (premio: any) => {
    setForm({
      ...
      stock_disponible: premio.stock_disponible
        ? Number(premio.stock_disponible)
        : null,
      tipo: premio.tipo,
            ...
            <div>
              ...
              <input
                ...
                onChange={e =>
                  setForm({
                    ...form,
                    costo_puntos: parseInt(e.target.value) || 0,
                  })
                }
                className="w-full border rounded px-3 py-2"
                min="1"
        ...
        {premios.map(premio => (
          <div key={premio.id_premio} className="bg-white rounded shadow p-4">
            ...
            <div className="space-y-1 text-sm">
              <p>
                <strong>Puntos:</strong> {premio.costo_puntos}
              </p>
              <p>
                <strong>Stock:</strong> {premio.stock_disponible ?? 'Ilimitado'}
              </p>
              <p>
                <strong>Tipo:</strong> {premio.tipo}
              </p>
              <p>
                <strong>Estado:</strong> {premio.estado}
              </p>
            </div>
