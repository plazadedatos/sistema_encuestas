...
export default function EncuestaInicialPage() {
  ...
  useEffect(() => {
    ...
    if (ciudadesParaguay && ciudadesParaguay.concept) {
      const ciudadesFormateadas = ciudadesParaguay.concept.map(
        (ciudad: any) => ({
          code: ciudad.code,
        ...
        <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 text-center">
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
            ...
            <p className="text-sm text-green-700">
              Gracias por completar tu perfil. Estos puntos ya están disponibles
              en tu cuenta.
            </p>
          </div>
  ...
  const hayAlgunCampoActivo = Object.values(configuracion.campos_activos).some(
    activo => activo
  );
        ...
        <div className="p-8">
          <div className="mb-6">
            ...
            <h2 className="text-xl font-semibold text-center text-gray-900 mb-2">
              Completa tu perfil y gana {configuracion.puntos_completar_perfil}{' '}
              puntos
            </h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-700 mt-1">
                    Al completar tu perfil recibirás{' '}
                    {configuracion.puntos_completar_perfil} puntos que podrás
                    usar para canjear premios. Solo se otorgan una vez por
                    usuario.
                  </p>
                </div>
              </div>
            ...
            <p className="text-xs text-gray-500 text-center">
              * Campos obligatorios. Esta información nos ayuda a personalizar
              tu experiencia.
            </p>
          </form>
        </div>
