  ...
  const handleCanjear = async (premio: Premio) => {
    ...
    try {
      ...
      if (e?.response?.status === 403) {
        ...
        setError("⚠️ Verificá tu correo electrónico para poder canjear premios. Te hemos enviado un correo de verificación.");
      } else {
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-yellow-700">
                <p>
                  Para poder canjear premios, necesitas verificar tu correo electrónico. 
