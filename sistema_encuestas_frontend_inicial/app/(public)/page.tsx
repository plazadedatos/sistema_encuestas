  ...
  useEffect(() => {
    const cargarEncuestas = async () => {
      try {
        ...
        const encuestasPublicas =
          await encuestasService.obtenerEncuestasActivas({
            limit: 6,
      ...
      <section className="container mx-auto px-4 py-20">
        <section className="max-w-7xl mx-auto px-4 py-20">
          ...
          <p className="text-center text-gray-700 max-w-2xl mx-auto text-md md:text-lg mb-12 leading-relaxed">
            En <strong>Plaza de Datos</strong>, ganas puntos por solo responder
            encuestas desde tu celular o computadora. Luego podrás canjearlos
            por increíbles premios reales, ¡y todo en pocos minutos!
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 text-center text-slate-800">
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-sm">
                Inicia sesión desde tu{' '}
                <span className="font-semibold">computadora o celular</span>
              </p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-sm">
                Responde encuestas online y{' '}
                <span className="font-semibold">gana puntos</span>
              </p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-sm">
                Cambia tus puntos por{' '}
                <span className="font-semibold">premios reales</span>
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="encuestas" className="max-w-7xl mx-auto px-4 py-24">
          ...
          <p className="text-center text-gray-600 mb-10">
            Participa en nuestras encuestas y acumula puntos que podrás canjear
            por increíbles premios. ¡Tu opinión es valiosa!
          </p>
          ...
          <div className="space-y-6">
            ...
            <details className="group border-b border-gray-200 pb-4">
              <summary className="flex items-center justify-between cursor-pointer text-lg font-semibold text-slate-800">
                ...
                <span className="transition-transform group-open:rotate-90 text-primary">
                  ▶
                </span>
              </summary>
              <p className="text-sm text-slate-600 mt-2">
                Solo necesitas registrarte llenando un pequeño formulario con
                tus datos básicos. Luego de confirmar tu correo electrónico,
                podrás comenzar a responder encuestas y ganar puntos.
              </p>
            </details>
            ...
            <details className="group border-b border-gray-200 pb-4">
              ...
              <p className="text-sm text-slate-600 mt-2">
                Desde tarjetas de regalo, productos, descuentos hasta sorteos
                exclusivos. Todo depende de la cantidad de puntos que acumules.
              </p>
            </details>
            ...
            <details className="group border-b border-gray-200 pb-4">
              ...
              <p className="text-sm text-slate-600 mt-2">
                Cualquier persona mayor de 18 años con acceso a internet puede
                registrarse y formar parte de la comunidad de Plaza de Datos.
              </p>
            </details>
            ...
            <details className="group border-b border-gray-200 pb-4">
              ...
              <p className="text-sm text-slate-600 mt-2">
                La mayoría toma entre 3 y 10 minutos. Siempre verás el tiempo
            ...
            <details className="group border-b border-gray-200 pb-4">
              ...
              <p className="text-sm text-slate-600 mt-2">
                Absolutamente. Toda tu información está protegida por políticas
                de privacidad y cifrado. Nunca compartimos tus datos sin tu
                consentimiento.
              </p>
            </details>
            ...
            <details className="group border-b border-gray-200 pb-4">
              ...
              <p className="text-sm text-slate-600 mt-2">
                Sí, puedes darte de baja en cualquier momento desde tu perfil.
                Tus datos se eliminarán si lo solicitás.
              </p>
            </details>
          </div>
        </section>
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed text-base md:text-lg">
                En <strong>Plaza de Datos</strong>, somos un equipo apasionado
                por la recopilación inteligente de datos para generar impacto
                real. Nuestro objetivo es{' '}
                <span className="font-medium">
                  conectar personas y organizaciones
                </span>{' '}
                a través de encuestas estratégicas, estadísticas y participación
                ciudadana.
                <br />
                <br />
                Promovemos la voz de la gente y convertimos sus respuestas en
                oportunidades de mejora para empresas, instituciones y
                comunidades. Creemos en el poder de la información colectiva
